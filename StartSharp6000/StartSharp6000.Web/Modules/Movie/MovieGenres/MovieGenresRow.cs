...
{
    [ConnectionKey("Default"), Module("Movie"), TableName("[mov].[MovieGenres]")]
    ...
    public sealed class MovieGenresRow : Row<MovieGenresRow.RowFields>, IIdRow
    {
        ...
        [DisplayName("Movie Status"), Expression("jMovie.[Status]")]
        public int? MovieStatus
        {
            get => fields.MovieStatus[this];
            set => fields.MovieStatus[this] = value;
        }
